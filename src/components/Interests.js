...
//       <Card.Img className='expimg' variant="top" src="holder.js/100px180" />
//       <Card.Body>
        ...
        <div id='interests'>
            ...
            <Container >
                <Row>
                    ...
                    <Col>
                        <Card className='widecard'>
                            <Card.Img className='expimg' variant="top" src={shsvip} alt="VIP" />
                            <Card.Body>
                ...
                <Row>
                    <Col>
                        <Card className='widecard'>
                            <container>
                                <Card.Img className='expimg' variant="top" src={boyScouts} alt="Boy Scouts" />
                            </container>
                            < Card.Body>
